...
// // 1. Timezone ab .env se aayega
// const BUSINESS_TIMEZONE = process.env.BUSINESS_TIMEZONE || 'Australia/Sydney';

// // 2. URLs ab .env se aayenge taake live server par masla na ho
...
// // 3. Purana Test Event Function (Locksmith ke liye updated)
...
//         const event = {
//             summary: 'Locksmith Test Booking',
//             description: 'Yeh ek test appointment hai jo hamare naye AI Locksmith system ne automatically create ki hai!',
//             start: {
...
// // 4. Vendor ke Free Slots check karna (24/7 Locksmith ke liye updated)
...
//         if (events.length === 0) {
//             return "Tomorrow is COMPLETELY FREE. We operate 24/7, so you can offer any time (Morning, Afternoon, or Night).";
//         }
...
//         return `Tomorrow's ALREADY BOOKED & BUSY SLOTS: [ ${busySlots.join(', ')} ]. DO NOT OFFER OR BOOK THESE TIMES! We operate 24/7, so offer any free slots outside these busy periods.`;
//     } catch (error) {
...
// // 5. Event Create karne se pehle STRICT OVERLAP CHECK
...
//         // 🔥 LOCKSMITH CALENDAR EVENT DETAILS ADDED 🔥
//         const event = {
//             summary: `Locksmith: ${aiData.service_type || 'Service Call'} | ${aiData.address || 'Address N/A'}`,
